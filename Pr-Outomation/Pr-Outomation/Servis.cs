...
namespace Pr_Outomation
{
    public partial class Servis : Form
    {
...

        {
            ...
            da = new SqlDataAdapter("Select *From Servicess", con);
            ds = new DataSet();
            con.Open();
        ...
        private void Ekle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "INSERT INTO Servicess (Marka,Model,Açıklama,Tarih) values (@Marka,@Model,@Açıklama,@Tarih)";
        ...
        private void guncelle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "UPDATE Servicess SET Marka=@Marka,Model=@Model, Açıklama=@Açıklama,Tarih=@Tarih where Marka=@Marka";
            cmd.Parameters.AddWithValue("@Marka", Marka.Text);
            cmd.Parameters.AddWithValue("@Model", Model.Text);
            cmd.Parameters.AddWithValue("@Açıklama", Açıklama.Text);
            cmd.Parameters.AddWithValue("@Tarih", dateTimePicker1.Text);
        ...
        private void sil_btn_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "DELETE FROM [Servicess] WHERE Marka=@Marka";
        ...
        {
            da = new SqlDataAdapter("Select * FROM Servicess WHERE Marka Like '" + texsearch.Text + "%'", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "Servicess");
            con.Close();
