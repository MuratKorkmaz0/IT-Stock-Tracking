...
namespace Pr_Outomation
{
    public partial class Stok : Form
    {
...

        {
            ...
            da = new SqlDataAdapter("Select *From stkk", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "stkk");
            dataGridView1.DataSource = ds.Tables["stkk"];
            con.Close();
        }
        ...
        private void Ekle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "INSERT INTO stkk (Marka,Model,Açıklama,Tarih) values (@Marka,@Model,@Açıklama,@Tarih)";
        ...
        private void guncelle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "UPDATE stkk SET Marka=@Marka,Model=@Model,Açıklama=@Açıklama,Tarih=@Tarih WHERE Marka=@Marka";
            cmd.Parameters.AddWithValue("@Marka", Marka.Text);
            cmd.Parameters.AddWithValue("@Model", Model.Text);
            cmd.Parameters.AddWithValue("@Açıklama", Açıklama.Text);
            cmd.Parameters.AddWithValue("@Tarih", dateTimePicker1.Text);
        ...
        */
            ...
            cmd.CommandText = "DELETE FROM [stkk] WHERE Marka=@Marka";
        ...
        {
            /*
             string query = "SELECT * FROM stokk WHERE Model like '%"+valueToSearch+"%'";
              SqlCommand cmd = new SqlCommand(query, con);
               ...
               da.Fill(ds, "Dgrchaz");
               con.Close();
            dataGridView1.DataSource = ds.Tables["stokk"];
            */
        ...
        {
            da = new SqlDataAdapter("Select * FROM stkk WHERE Marka Like '" + texsearch.Text + "%'", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "stkk");
            con.Close();
