...
{
    public partial class Deshim : Form
    {
        public Deshim()
        {
            InitializeComponent();
...

        {
            ...
            da = new SqlDataAdapter("Select *From Deshim", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "Deshim");
            dataGridView1.DataSource = ds.Tables["Deshim"];
            con.Close();
        }
        ...
        private void Ekle_btn_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            cmd = new SqlCommand(Connect.PrCon);
                con.Open();
                cmd.Connection = con;
                cmd.CommandText = "INSERT INTO Deshim (Yazıcı,Model,Toner,Tarih) values (@Yazıcı,@Model,@Toner,@Tarih)";
        ...
        private void guncelle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "UPDATE Deshim SET Yazıcı=@Yazıcı,Model=@Model,Toner=@Toner,Tarih=@Tarih where Yazıcı=@Yazıcı";
            cmd.Parameters.AddWithValue("@Yazıcı", YazıcıTBox.Text);
            cmd.Parameters.AddWithValue("@Model", Toner_ModelTBox.Text);
            cmd.Parameters.AddWithValue("@Toner", comboBox1.Text);
            cmd.Parameters.AddWithValue("@Tarih", dateTimePicker1.Text);
        ...
        private void sil_btn_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "DELETE FROM Deshim] WHERE Yazıcı=@Yazıcı";
        ...
        private void Deshim_Load(object sender, EventArgs e)
        {
            Griddol();
        }
    }
