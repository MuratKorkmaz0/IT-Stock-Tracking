...
{
    public partial class Itfam : Form
    {
        public Itfam()
        {
            InitializeComponent();
...

        {
            ...
            da = new SqlDataAdapter("Select *From Itfam", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "Itfam");
            dataGridView1.DataSource = ds.Tables["Itfam"];
            con.Close();
        }
        ...
        private void Ekle_btn_Click(object sender, EventArgs e)
        {
           ...
           */
                ...
                con.Open();
                cmd.Connection = con;
                cmd.CommandText = "INSERT INTO Itfam (Yazıcı,Model,Toner,Tarih) values (@Yazıcı,@Model,@Toner,@Tarih)";
        ...
        private void guncelle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "UPDATE Itfam SET Yazıcı=@Yazıcı,Model=@Model,Toner=@Toner,Tarih=@Tarih where Yazıcı=@Yazıcı";
            cmd.Parameters.AddWithValue("@Yazıcı", YazıcıTBox.Text);
            cmd.Parameters.AddWithValue("@Model", Toner_ModelTBox.Text);
            cmd.Parameters.AddWithValue("@Toner", comboBox1.Text);
            cmd.Parameters.AddWithValue("@Tarih", dateTimePicker1.Text);
        ...
        private void sil_btn_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "DELETE FROM [Itfam] WHERE Yazıcı=@Yazıcı";
        ...
        private void Itfam_Load(object sender, EventArgs e)
        {
            Griddol();
        }
