...
namespace Pr_Outomation
{
    ...
    public partial class Yazı_isleri : Form
    {
        public Yazı_isleri()
        {
            InitializeComponent();
        ...
        void Griddol()
        {
            ...
            da = new SqlDataAdapter("Select *From Yazı_isleri", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "Yazı_isleri");
            dataGridView1.DataSource = ds.Tables["Yazı_isleri"];
            con.Close();
        }
        ...
        private void Ekle_btn_Click(object sender, EventArgs e)
        {
            ...
            */
                ...
                con.Open();
                cmd.Connection = con;
                cmd.CommandText = "INSERT INTO Yazı_isleri (Yazıcı,Model,Toner,Tarih) values (@Yazıcı,@Model,@Toner,@Tarih)";
        ...
        private void sil_btn_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "DELETE FROM [Yazı_isleri] WHERE Yazıcı=@Yazıcı";
        ...
        private void guncelle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "UPDATE Yazı_isleri SET Yazıcı=@Yazıcı,Model=@Model,Toner=@Toner,Tarih=@Tarih where Yazıcı=@Yazıcı";
            cmd.Parameters.AddWithValue("@Yazıcı", YazıcıTBox.Text);
            cmd.Parameters.AddWithValue("@Model", Toner_ModelTBox.Text);
            cmd.Parameters.AddWithValue("@Toner", comboBox1.Text);
            cmd.Parameters.AddWithValue("@Tarih", dateTimePicker1.Text);
        ...
        private void Yazı_isleri_Load(object sender, EventArgs e)
        {
            Griddol();
        }
