...
{
    public partial class Park_b : Form
    {
        public Park_b()
        {
            InitializeComponent();
        ...
        void Griddol()
        {
            ...
            da = new SqlDataAdapter("Select *From Park_b", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "Park_b");
            dataGridView1.DataSource = ds.Tables["Park_b"];
            con.Close();
        }
        ...
        private void Ekle_btn_Click(object sender, EventArgs e)
        {
          ...
          */
                ...
                con.Open();
                cmd.Connection = con;
                cmd.CommandText = "INSERT INTO Park_b (Yazıcı,Model,Toner,Tarih) values (@Yazıcı,@Model,@Toner,@Tarih)";
        ...
        private void sil_btn_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "DELETE FROM [Park_b] WHERE Yazıcı=@Yazıcı";
        ...
        private void guncelle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "UPDATE Park_b SET Yazıcı=@Yazıcı,Model=@Model,Toner=@Toner,Tarih=@Tarih where Yazıcı=@Yazıcı";
            cmd.Parameters.AddWithValue("@Yazıcı", YazıcıTBox.Text);
            cmd.Parameters.AddWithValue("@Model", Toner_ModelTBox.Text);
            cmd.Parameters.AddWithValue("@Toner", comboBox1.Text);
            cmd.Parameters.AddWithValue("@Tarih", dateTimePicker1.Text);
        ...
        private void Park_b_Load(object sender, EventArgs e)
        {
            Griddol();
        }
