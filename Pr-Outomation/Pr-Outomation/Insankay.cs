...
{
    public partial class Insankay : Form
    {
        public Insankay()
        {
            InitializeComponent();
...

        {
            ...
            da = new SqlDataAdapter("Select *From InKay", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "InKay");
            dataGridView1.DataSource = ds.Tables["InKay"];
            con.Close();
        }
        ...
        private void Ekle_btn_Click(object sender, EventArgs e)
        {
          ...
          */
                ...
                con.Open();
                cmd.Connection = con;
                cmd.CommandText = "INSERT INTO InKay (Yazıcı,Model,Toner,Tarih) values (@Yazıcı,@Model,@Toner,@Tarih)";
        ...
        private void guncelle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "UPDATE InKay SET Yazıcı=@Yazıcı,Model=@Model,Toner=@Toner,Tarih=@Tarih where Yazıcı=@Yazıcı";
            cmd.Parameters.AddWithValue("@Yazıcı", YazıcıTBox.Text);
            cmd.Parameters.AddWithValue("@Model", Toner_ModelTBox.Text);
            cmd.Parameters.AddWithValue("@Toner", comboBox1.Text);
            cmd.Parameters.AddWithValue("@Tarih", dateTimePicker1.Text);
        ...
        private void sil_btn_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "DELETE FROM [InKay] WHERE Yazıcı=@Yazıcı";
        ...
        private void Insankay_Load(object sender, EventArgs e)
        {
