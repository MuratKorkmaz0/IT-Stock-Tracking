...
{
    public partial class Yazıcılar : Form
    {
        public Yazıcılar()
        {
            InitializeComponent();
      ...
      //DataTable Table;
...

        {
            ...
            da = new SqlDataAdapter("Select *From Yacılarr", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "Yacılarr");
            dataGridView1.DataSource = ds.Tables["Yacılarr"];
            con.Close();
        }
        ...
        private void Cihazlar_btn_Click(object sender, EventArgs e)
        {
        ...
        private void Ekle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "INSERT INTO Yacılarr (Marka,Model,Açıklama,Tarih) values (@Marka,@Model,@Açıklama,@Tarih)";
        ...
        private void guncelle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "UPDATE Yacılarr SET Marka=@Marka,Model=@Model, Açıklama=@Açıklama,Tarih=@Tarih where Marka=@Marka";
            cmd.Parameters.AddWithValue("@Marka", Marka.Text);
            cmd.Parameters.AddWithValue("@Model", Model.Text);
            cmd.Parameters.AddWithValue("@Açıklama", Açıklama.Text);
            cmd.Parameters.AddWithValue("@Tarih", dateTimePicker1.Text);
        ...
        private void sil_btn_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "DELETE FROM [Yacılarr] WHERE Marka=@Marka";
        ...
        private void Yazıcılar_Load(object sender, EventArgs e)
        {
            searchData("");
            Griddol();
        }
            ...
            /*
             string query = "SELECT * FROM Bilg WHERE Model like '%"+valueToSearch+"%'";
              SqlCommand cmd = new SqlCommand(query, con);
               ...
               da.Fill(ds, "Yacılar");
               con.Close();
            dataGridView1.DataSource = ds.Tables["Yacılar"];
            */
        ...
        {
            da = new SqlDataAdapter("Select * FROM Yacılarr WHERE Marka Like '" + texsearch.Text + "%'", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "Yacılarr");
            con.Close();
