...
{
    public partial class Cevre_k : Form
    {
        public Cevre_k()
        {
            InitializeComponent();
        ...
        void Griddol()
        {
            ...
            da = new SqlDataAdapter("Select *From Cevre_k", con);
            ds = new DataSet();
            con.Open();
            da.Fill(ds, "Cevre_k");
            dataGridView1.DataSource = ds.Tables["Cevre_k"];
            con.Close();
        }
        ...
        private void Ekle_btn_Click(object sender, EventArgs e)
        {
          ...
          */
          //  {
                ...
                con.Open();
                cmd.Connection = con;
                cmd.CommandText = "INSERT INTO Cevre_k (Yazıcı,Model,Toner,Tarih) values (@Yazıcı,@Model,@Toner,@Tarih)";
        ...
        private void sil_btn_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "DELETE FROM [Cevre_k] WHERE Yazıcı=@Yazıcı";
        ...
        private void guncelle_btn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "UPDATE Cevre_k SET Yazıcı=@Yazıcı,Model=@Model,Toner=@Toner,Tarih=@Tarih where Yazıcı=@Yazıcı";
            cmd.Parameters.AddWithValue("@Yazıcı", YazıcıTBox.Text);
            cmd.Parameters.AddWithValue("@Model", Toner_ModelTBox.Text);
            cmd.Parameters.AddWithValue("@Toner", comboBox1.Text);
            cmd.Parameters.AddWithValue("@Tarih", dateTimePicker1.Text);
        ...
        private void Cevre_k_Load(object sender, EventArgs e)
        {
            Griddol();
        }
